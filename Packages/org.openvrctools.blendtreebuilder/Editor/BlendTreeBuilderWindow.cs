...
using static OpenVRCTools.BlendTreeBulder.BlendTreeBuilderCustomGUI;
using static OpenVRCTools.BlendTreeBulder.BlendTreeBuilderMain;
using static OpenVRCTools.BlendTreeBulder.BlendTreeBuilderHelper;
using System.Linq;

namespace OpenVRCTools.BlendTreeBulder
{
    public class BlendTreeBuilderWindow : EditorWindow
    {
        #region Constants
        public const string GENERATED_ASSETS_PATH = "Assets/OpenVRCTools/BlendTreeBuilder/Generated Assets";
